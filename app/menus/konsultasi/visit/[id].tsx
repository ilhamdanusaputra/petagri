...
import { useVisit, type VisitDetail, type VisitRecommendation } from "@/hooks/use-visit";
...
export default function VisitDetailPage() {
	...
	const { getVisitById, updateVisitStatus, saveVisitReport, saveRecommendations } = useVisit();
	...
	const handleSaveReport = async () => {
		...
		const reportResult = await saveVisitReport(id, {
			...
			gps_latitude: reportForm.gpsLatitude ? Number(reportForm.gpsLatitude) : null,
			gps_longitude: reportForm.gpsLongitude ? Number(reportForm.gpsLongitude) : null,
		...
		if (recommendations.length > 0) {
			const recResult = await saveRecommendations(reportResult.reportId!, recommendations);
					...
					<View style={{ marginTop: 12, gap: 10 }}>
						<View style={styles.infoRow}>
							<View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
								...
								<View style={{ flex: 1 }}>
									<ThemedText style={{ fontSize: 12, color: muted }}>Konsultan</ThemedText>
									<ThemedText style={{ fontSize: 14, fontWeight: "600", color: text }}>
						...
						<View style={styles.infoRow}>
							<View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
								...
								<View style={{ flex: 1 }}>
									<ThemedText style={{ fontSize: 12, color: muted }}>Jadwal Kunjungan</ThemedText>
									<ThemedText style={{ fontSize: 14, fontWeight: "600", color: text }}>
									...
									<ThemedText style={{ fontSize: 13, color: muted }}>
										{new Date(visit.scheduled_date).toLocaleTimeString("id-ID", {
											hour: "2-digit",
											minute: "2-digit",
										})}{" "}
										WIB
							...
							<View style={styles.infoRow}>
								<View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
									...
									<View style={{ flex: 1 }}>
										...
										<ThemedText style={{ fontSize: 14, fontWeight: "600", color: text }}>
											{new Date(visit.report.created_at).toLocaleDateString("id-ID", {
												weekday: "short",
												year: "numeric",
												month: "short",
												day: "numeric",
					...
					<View style={[styles.section, { backgroundColor: cardBg, borderColor: border }]}>
						...
						<View style={styles.fieldGroup}>
							...
							<TextInput
								...
								onChangeText={(val) => setReportForm({ ...reportForm, plantType: val })}
							/>
						</View>
						...
						<View style={styles.fieldGroup}>
							...
							<TextInput
								...
								onChangeText={(val) => setReportForm({ ...reportForm, plantAge: val })}
							/>
						</View>
						...
						<View style={styles.fieldGroup}>
							...
							<TextInput
								...
								onChangeText={(val) => setReportForm({ ...reportForm, landArea: val })}
								keyboardType="decimal-pad"
							/>
						</View>

						<View style={styles.fieldGroup}>
							<ThemedText style={styles.label}>Masalah yang Ditemukan *</ThemedText>
							<TextInput
								style={[
									styles.inputMulti,
									{ backgroundColor: inputBg, color: text, borderColor: border },
								...
								onChangeText={(val) => setReportForm({ ...reportForm, problems: val })}
								multiline
								numberOfLines={4}
							/>
						</View>
						...
						<View style={styles.fieldGroup}>
							<ThemedText style={styles.label}>Lokasi GPS (Opsional)</ThemedText>
							<View style={{ flexDirection: "row", gap: 8 }}>
								<TextInput
									style={[
										styles.input,
										{ flex: 1, backgroundColor: inputBg, color: text, borderColor: border },
									]}
									placeholder="Latitude"
									placeholderTextColor={placeholderColor}
									value={reportForm.gpsLatitude}
									onChangeText={(val) => setReportForm({ ...reportForm, gpsLatitude: val })}
									keyboardType="decimal-pad"
								/>
								<TextInput
									style={[
									...
									onChangeText={(val) => setReportForm({ ...reportForm, gpsLongitude: val })}
									keyboardType="decimal-pad"
								/>
							</View>
						</View>
						...
						<View style={styles.fieldGroup}>
							<ThemedText style={styles.label}>Catatan Cuaca (Opsional)</ThemedText>
							<TextInput
								style={[
									styles.input,
									{ backgroundColor: inputBg, color: text, borderColor: border },
								...
								onChangeText={(val) => setReportForm({ ...reportForm, weatherNotes: val })}
							/>
						</View>
					</View>
				)}
							...
							recommendations.map((rec, idx) => (
								<View
									...
									<View
										...
										<ThemedText style={{ fontWeight: "600" }}>Produk #{idx + 1}</ThemedText>
									...
									<View style={styles.fieldGroup}>
										<ThemedText style={styles.labelSmall}>Nama Produk *</ThemedText>
										<TextInput
											style={[
												styles.inputSmall,
												{ backgroundColor: inputBg, color: text, borderColor: border },
											...
											onChangeText={(val) => updateRecommendation(idx, "product_name", val)}
										/>
									</View>
									...
									<View style={styles.fieldGroup}>
										...
										<TextInput
											...
											placeholderTextColor={placeholderColor}
											value={rec.function}
											onChangeText={(val) => updateRecommendation(idx, "function", val)}
										/>
									</View>
									...
									<View style={styles.fieldGroup}>
										...
										<TextInput
											...
											placeholderTextColor={placeholderColor}
											value={rec.dosage}
											onChangeText={(val) => updateRecommendation(idx, "dosage", val)}
										/>
									</View>

									<View style={styles.fieldGroup}>
										<ThemedText style={styles.labelSmall}>Estimasi Kebutuhan (Qty) *</ThemedText>
										<TextInput
											style={[
												styles.inputSmall,
												{ backgroundColor: inputBg, color: text, borderColor: border },
											...
											onChangeText={(val) => updateRecommendation(idx, "estimated_qty", val)}
										/>
									</View>
									...
									<View style={styles.fieldGroup}>
										...
										<View style={{ flexDirection: "row", gap: 8 }}>
											<Pressable
												...
												onPress={() => updateRecommendation(idx, "urgency", "terjadwal")}>
												<ThemedText
													style={[
														{ fontSize: 13 },
														rec.urgency === "terjadwal"
											...
											<Pressable
												...
												onPress={() => updateRecommendation(idx, "urgency", "segera")}>
												<ThemedText
													style={[
														{ fontSize: 13 },
														rec.urgency === "segera"
									...
									<View style={styles.fieldGroup}>
										<ThemedText style={styles.labelSmall}>Alternatif Produk (Opsional)</ThemedText>
										<TextInput
											style={[
												styles.inputSmall,
												{ backgroundColor: inputBg, color: text, borderColor: border },
											...
											onChangeText={(val) => updateRecommendation(idx, "alternative_products", val)}
										/>
									</View>
								</View>
							))
						...
						<View style={[styles.section, { backgroundColor: cardBg, borderColor: border }]}>
							...
							<View style={{ gap: 10 }}>
								<View style={styles.detailRow}>
									<ThemedText style={styles.detailLabel}>Jenis Tanaman</ThemedText>
									<ThemedText style={styles.detailValue}>{visit.report.plant_type}</ThemedText>
								</View>
								<View style={styles.detailRow}>
									<ThemedText style={styles.detailLabel}>Umur Tanaman</ThemedText>
									<ThemedText style={styles.detailValue}>{visit.report.plant_age}</ThemedText>
								</View>
								<View style={styles.detailRow}>
									<ThemedText style={styles.detailLabel}>Luas Lahan</ThemedText>
									<ThemedText style={styles.detailValue}>{visit.report.land_area} ha</ThemedText>
								</View>
								<View style={styles.detailRow}>
									<ThemedText style={styles.detailLabel}>Masalah Ditemukan</ThemedText>
									<ThemedText style={[styles.detailValue, { flex: 1, textAlign: "left" }]}>
										{visit.report.problems}
									</ThemedText>
								</View>
								{visit.report.gps_latitude && visit.report.gps_longitude && (
									<View style={styles.detailRow}>
										<ThemedText style={styles.detailLabel}>Koordinat GPS</ThemedText>
								...
								{visit.report.weather_notes && (
									<View style={styles.detailRow}>
										<ThemedText style={styles.detailLabel}>Kondisi Cuaca</ThemedText>
										<ThemedText style={styles.detailValue}>{visit.report.weather_notes}</ThemedText>
									</View>
								)}
							</View>
						</View>
							...
							<View style={[styles.section, { backgroundColor: cardBg, borderColor: border }]}>
								<View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
									...
									<View
										...
										<ThemedText style={{ fontSize: 12, fontWeight: "600", color: tint }}>
								...
								{visit.recommendations.map((rec, idx) => (
									<View
										...
										<View
											...
											<View style={{ flex: 1 }}>
												<ThemedText style={{ fontSize: 15, fontWeight: "600", marginBottom: 4 }}>
													{rec.product_name}
												</ThemedText>
											</View>
										</View>
										<View
											style={{
												...
												borderRadius: 6,
												alignSelf: "flex-start",
												backgroundColor: rec.urgency === "segera" ? "#EF444420" : "#3B82F620",
											}}>
											<ThemedText
												style={{
													fontSize: 11,
													fontWeight: "600",
													color: rec.urgency === "segera" ? "#EF4444" : "#3B82F6",
												}}>
										...
										<View style={{ gap: 6, marginTop: 8 }}>
											<View style={{ flexDirection: "row" }}>
												<ThemedText style={{ color: muted, fontSize: 13, width: 80 }}>
													Fungsi
												</ThemedText>
												<ThemedText style={{ color: text, fontSize: 13, flex: 1 }}>
													: {rec.function}
												</ThemedText>
											</View>
											<View style={{ flexDirection: "row" }}>
