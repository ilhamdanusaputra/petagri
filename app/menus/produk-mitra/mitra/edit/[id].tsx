...
export default function MitraDetailPage() {
	...
	const { mitraList, updateMitra, fetchMitra } = useMitraToko();
	...
	const handleSave = async () => {
		...
		const res = await updateMitra(id as string, form);
		if (!res.success) {
			setErrorMsg(res.error || "Gagal memperbarui mitra");
			setSaving(false);
			return;
		}
		setSaving(false);
