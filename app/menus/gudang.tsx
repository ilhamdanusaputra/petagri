				...
				<ScrollView horizontal showsHorizontalScrollIndicator={false}>
					<View className="flex-row gap-4">
						<View className="bg-red-900/20 border border-red-800 rounded-xl p-4 min-w-[120px]">
							<ThemedText className="text-red-400 text-2xl font-bold">{outOfStockCount}</ThemedText>
								...
								<View
									...
									<View className="flex-row items-center justify-between">
										...
										<Pressable
											...
											<ThemedText className="text-white text-sm font-medium">Sesuaikan</ThemedText>
										</Pressable>
									</View>
								...
								<View
									...
									<View className="flex-row items-center justify-between mb-2">
										<View className="flex-1">
											...
											<ThemedText className="text-gray-400 text-sm">SKU: {movement.sku}</ThemedText>
										</View>
										<View
