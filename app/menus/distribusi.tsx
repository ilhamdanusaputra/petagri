...
export default function DistribusiMenu() {
	...
	return (
		<ThemedView style={styles.container}>
			...
			<Pressable
				...
				<View style={styles.cardBody}>
					...
					<ThemedText style={[styles.cardDesc, { color: textColor }]}>
						Tambah, edit, dan nonaktifkan driver pengiriman. Pantau status driver dan riwayat
						pengiriman.
					</ThemedText>
				</View>
			</Pressable>
			...
			<Pressable
				onPress={() => router.push("/menus/distribusi/kelola" as Href)}
				...
				<View style={styles.cardBody}>
					...
					<ThemedText style={[styles.cardDesc, { color: textColor }]}>
						Atur dan pantau distribusi barang, status pengiriman, dan detail logistik secara
						real-time.
					</ThemedText>
				</View>
			</Pressable>
